package com.org.generation.blogpessoal_1.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.org.generation.blogpessoal_1.controller"))
	...
	private static Contact contact() {
		...
		return new Contact("Deivite Oliveira", "https://github.com/deiviteoliveira", "deiviteoliveira03@gmail.com");
	}
